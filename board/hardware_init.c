...
/*${function:start}*/
/* EMAC RMII 50 MHz clock tree selection and module clock enable. */
...
/* SDK hook: select the RMII/MII interface mode in DCM_GPR
 * (called from ENET_QOS_Init). */
...
/* SDK hook: gate the EMAC module clock. */
...
/*${function:start}*/
/* One-shot board bring-up: MPU, pin mux, clock tree, debug console,
 * PHY reset sequencing, MDIO resource and FlexCAN PE clock attach. */
